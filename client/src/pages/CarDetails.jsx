...
const CarDetails = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      <button onClick={() => navigate(-1)} className="flex items-center gap-5 mb-6 text-gray-500 cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white cursor-pointer rounded-xl"
          >
            Book Now
          </button>
